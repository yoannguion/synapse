...
class BaseProfileHandler(BaseHandler):
    ...
    async def set_displayname(self, target_user, requester, new_displayname, by_admin=False):
    ...
    async def set_avatar_url(self, target_user, requester, new_avatar_url, by_admin=False):
